...
import io.mosip.kernel.emailnotification.constant.DateUtilConstants;
import io.mosip.kernel.emailnotification.exception.IllegalArgumentException;
import io.mosip.kernel.emailnotification.exception.NullPointerException;
...
public final class DateUtils {
	...
	public static LocalDateTime parseUTCToLocalDateTime(String utcDateTime, String pattern) {
		...
		try {
			...
			throw new io.mosip.kernel.emailnotification.exception.ParseException(
